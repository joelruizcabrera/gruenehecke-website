  ...
  <footer class="footer">
    <div class="container">
      <div class="footer-content">
        ...
        <div class="footer-section">
          ...
          <nav class="footer-nav">
            ...
            <NuxtLink to="/standorte" class="footer-link">Standorte</NuxtLink>
            <NuxtLink to="/jobs" class="footer-link">Jobs</NuxtLink>
            <NuxtLink to="/kontakt" class="footer-link">Kontakt</NuxtLink>
          </nav>
        </div>
      ...
      <div class="footer-bottom">
        <p class="copyright">
          &copy; {{ currentYear }} Grüne Hecke. Alle Rechte vorbehalten.
        </p>
